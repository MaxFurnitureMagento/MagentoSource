...
class Celebros_Conversionpro_Model_SalespersonSearchApi extends Mage_Core_Model_Abstract
{
    ...
    {
        $this->_init('conversionpro/salespersonSearchApi');
        if (Mage::getStoreConfig('conversionpro/general_settings/host') != '' && Mage::getStoreConfig('conversionpro/general_settings/port') != '' && Mage::getStoreConfig('conversionpro/general_settings/sitekey') != ''){
	        $this->HostName = Mage::getStoreConfig('conversionpro/general_settings/host');
	        if (preg_match('/http:\/\//',$this->HostName)){
	        	$this->HostName = preg_replace('/http::\/\//','', $this->HostName);
	        }
			$this->CommunicationPort = Mage::getStoreConfig('conversionpro/general_settings/port');
			$this->SiteKey = Mage::getStoreConfig('conversionpro/general_settings/sitekey');
