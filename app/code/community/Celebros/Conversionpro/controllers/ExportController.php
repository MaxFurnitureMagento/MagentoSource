 ...
 *
 */
class Celebros_Conversionpro_ExportController extends Mage_Adminhtml_Controller_Action
{

	public function export_celebrosAction()
	{
		$model=Mage::getModel('conversionpro/exporter');
	...
	public function schedule_exportAction() {
        ...
        if ($config instanceof Mage_Core_Model_Config_Element) {
			...
			foreach ($jobs as $jobCode => $jobConfig) {
				if(strpos($jobCode, 'conversionpro') === false) continue;
