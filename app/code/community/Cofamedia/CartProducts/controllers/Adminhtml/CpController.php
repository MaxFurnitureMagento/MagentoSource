<?php
class Cofamedia_CartProducts_Adminhtml_CpController extends Mage_Adminhtml_Controller_Action
{

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('cofamedia/cartproducts')
			->_addBreadcrumb(Mage::helper('adminhtml')->__('Cart Products Manager'), Mage::helper('adminhtml')->__('Cart Products Manager'));
