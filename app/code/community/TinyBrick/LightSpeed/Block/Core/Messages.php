 ...
 */
class TinyBrick_LightSpeed_Block_Core_Messages extends Mage_Core_Block_Messages
{
    /**
     * Messages collection
     *
    ...
    {
		//Prevents Pages with Messages on them from being cached
		if (count($this->getMessages()) && $rootBlock = $this->getLayout()->getBlock('root')){
			$rootBlock->setCachePage(false);
		}
