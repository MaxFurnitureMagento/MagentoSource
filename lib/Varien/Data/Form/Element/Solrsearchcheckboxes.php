 ...
 */
class Varien_Data_Form_Element_SolrSearchCheckboxes extends Varien_Data_Form_Element_Abstract
{
    ...
    {
        return array('type', 'name', 'class', 'style', 'onclick', 'onchange', 'disabled');
    }
...
//    }
    ...
    protected function _optionToHtml($option)
    {
		...
		$saveValue = $this->getValue();
		$checks = explode(',',$saveValue);
