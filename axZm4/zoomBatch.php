...
Based on this example it is surely possible to make a cron job suited procedure. 

!! You schould adjust this example to suit your needs.
!! set $zoom['config']['pic'] below as "base directory" of your images
...
/*
$zoom['config']['im'] = true; // Use Imagemagick to crop images, make intitial images and thumbs
$zoom['config']['pyrProg'] = 'IM'; // Image tiles program IM or GD
$zoom['config']['gPyramidProg'] = 'IM'; // Pyramid program IM or GD
...
if (isset($_GET['previewPic'])){
	ob_start();
	$axZm->rawThumb($zoom,$zoom['config']['picDir'],urldecode($_GET['previewPic']),$zoom['batch']['prevWidth'],$zoom['batch']['prevHeight'],$qual=100);
	ob_end_flush();
	exit;
}
